    ...
    return (
        <>
            <footer className=" bg-gray-100">
                <div className="relative bg-white pt-8 pb-6 rounded-t-xl shadow-2xl">
                    <div className="container max-w-7xl mx-auto px-4">
                        <div className="flex flex-wrap text-center lg:text-left pt-6">
                            <div className="w-full lg:w-6/12 px-4">
                                <H5 color="gray">Dallin Jared</H5>
                                <div className="-mt-4">
                                    <LeadText color="blueGray">
                                        Striving to work on the cutting-edge of technology.
                                    </LeadText>
                                </div>
                                <div className="flex gap-2 mt-6 lg:justify-center lg:mb-0 mb-8 justify-center">
                                    <a
                                ...
                                <div className="flex flex-wrap items-top">
                                    <div className="w-full lg:w-4/12 px-4 ml-auto md:mb-0 mb-8">
                                        ...
                                        <ul className="list-unstyled">
                                            ...
                                            <li>
                                                <a
                                                    href="https://www.github.com/dallinjared"
                                                    target="_blank"
                                                    rel="noreferrer"
                                                    className="text-gray-700 hover:text-gray-900 block pb-2 text-sm"
                                                >
