...
export default function StatusLinkCard({ color, icon, title, children, link }) {
    return (
        <div className="my-2 md:my-0 w-full md:w-4/12 px-4 flex justify-center text-center">
            <Card>
                <CardBody>
                    <div
                    ...
                    <H6 color="gray"><a href={link}>{title}</a></H6>
